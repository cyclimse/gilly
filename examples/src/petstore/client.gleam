// Code generated by Gilly (0.1.5) from OpenAPI specification at 'samples/petstore.json'. DO NOT EDIT.
...
pub type ApiResponse {
  ApiResponse(code: Option(Int), message: Option(String), type_: Option(String))
}
...
pub type Category {
  Category(id: Option(Int), name: Option(String))
}
...
pub fn order_decoder() -> decode.Decoder(Order) {
  ...
  use id <- decode.optional_field("id", None, decode.optional(decode.int))
  use pet_id <- decode.optional_field(
    "petId",
    None,
  ...
  use ship_date <- decode.optional_field(
    "shipDate",
    None,
    decode.optional(decode.string),
  )
  use status <- decode.optional_field(
    "status",
    None,
    decode.optional(order_status_decoder()),
  )
...
pub fn pet_decoder() -> decode.Decoder(Pet) {
  use category <- decode.optional_field(
    "category",
    None,
    decode.optional(category_decoder()),
  )
  use id <- decode.optional_field("id", None, decode.optional(decode.int))
...
pub type Tag {
  Tag(id: Option(Int), name: Option(String))
}
...
pub fn user_decoder() -> decode.Decoder(User) {
  ...
  use user_status <- decode.optional_field(
    "userStatus",
    None,
    decode.optional(decode.int),
  )
...
pub fn add_pet(client: Client(err), body: Pet) -> Result(Pet, ApiError(err)) {
...
pub fn update_pet(client: Client(err), body: Pet) -> Result(Pet, ApiError(err)) {
  let assert Ok(req) = request.to(client.base_url <> "/pet")
...
pub fn get_pet_by_id(
  ...
  let assert Ok(req) =
    request.to(client.base_url <> "/pet/" <> int.to_string(pet_id))
  let req = request.set_method(req, http.Get)
  let req = request.prepend_header(req, "content-type", "application/json")
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
...
pub fn upload_file(
  ...
  let assert Ok(req) =
    request.to(
      client.base_url <> "/pet/" <> int.to_string(pet_id) <> "/uploadImage",
    )
  let req = request.set_method(req, http.Post)
  let req = request.prepend_header(req, "content-type", "application/json")
  let query = []
...
pub fn get_inventory(client: Client(err)) -> Result(Dynamic, ApiError(err)) {
...
pub fn get_order_by_id(
  ...
  let assert Ok(req) =
    request.to(client.base_url <> "/store/order/" <> int.to_string(order_id))
  let req = request.set_method(req, http.Get)
  let req = request.prepend_header(req, "content-type", "application/json")
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
...
pub fn create_users_with_list_input(
  ...
  let req =
    request.set_body(
      req,
      json.to_string(json.array(body, fn(item) { user_to_json(item) })),
    )
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
  )
...
pub fn logout_user(client: Client(err)) -> Result(Nil, ApiError(err)) {
