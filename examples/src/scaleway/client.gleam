// Code generated by Gilly (0.1.5) from OpenAPI specification at 'samples/scaleway_containers.json'. DO NOT EDIT.
...
pub fn scaleway_containers_v1beta1_container_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1Container,
) {
  ...
  use environment_variables <- decode.field(
  ...
  use http_option <- decode.field(
    "http_option",
    scaleway_containers_v1beta1_container_http_option_decoder(),
  )
  ...
  use privacy <- decode.field(
    "privacy",
    scaleway_containers_v1beta1_container_privacy_decoder(),
  )
  use private_network_id <- decode.optional_field(
    "private_network_id",
    None,
    decode.optional(decode.string),
  )
  use protocol <- decode.field(
    "protocol",
    scaleway_containers_v1beta1_container_protocol_decoder(),
  )
  use ready_at <- decode.optional_field(
    "ready_at",
    None,
    decode.optional(decode.string),
  )
  ...
  use sandbox <- decode.field(
    "sandbox",
    scaleway_containers_v1beta1_container_sandbox_decoder(),
  )
  use scaling_option <- decode.field("scaling_option", decode.dynamic)
  use secret_environment_variables <- decode.field(
    "secret_environment_variables",
    decode.list(scaleway_containers_v1beta1_secret_hashed_value_decoder()),
  )
  use status <- decode.field(
    "status",
    scaleway_containers_v1beta1_container_status_decoder(),
  )
  ...
  decode.success(ScalewayContainersV1beta1Container(
    args:,
    command:,
    cpu_limit:,
    created_at:,
...
pub fn scaleway_containers_v1beta1_container_to_json(
  value: ScalewayContainersV1beta1Container,
) -> json.Json {
  json.object([
    ...
    #(
      "http_option",
      json.string(scaleway_containers_v1beta1_container_http_option_to_string(
        value.http_option,
      )),
    ),
    ...
    #(
      "privacy",
      json.string(scaleway_containers_v1beta1_container_privacy_to_string(
        value.privacy,
      )),
    ),
    #(
      "private_network_id",
      json.nullable(value.private_network_id, json.string),
    ),
    #(
      "protocol",
      json.string(scaleway_containers_v1beta1_container_protocol_to_string(
        value.protocol,
      )),
    ),
    ...
    #(
      "sandbox",
      json.string(scaleway_containers_v1beta1_container_sandbox_to_string(
        value.sandbox,
      )),
    ),
    ...
    #(
      "secret_environment_variables",
      json.array(value.secret_environment_variables, fn(item) {
        scaleway_containers_v1beta1_secret_hashed_value_to_json(item)
      }),
    ),
    #(
      "status",
      json.string(scaleway_containers_v1beta1_container_status_to_string(
        value.status,
      )),
    ),
...
pub fn scaleway_containers_v1beta1_cron_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1Cron,
) {
  ...
  use status <- decode.field(
    "status",
    scaleway_containers_v1beta1_cron_status_decoder(),
  )
  decode.success(ScalewayContainersV1beta1Cron(
    args:,
    container_id:,
    id:,
    name:,
...
pub fn scaleway_containers_v1beta1_cron_to_json(
  value: ScalewayContainersV1beta1Cron,
) -> json.Json {
  json.object([
    #("args", json.null()),
    ...
    #(
      "status",
      json.string(scaleway_containers_v1beta1_cron_status_to_string(
        value.status,
      )),
    ),
  ])
...
pub fn scaleway_containers_v1beta1_domain_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1Domain,
) {
  use container_id <- decode.field("container_id", decode.string)
  use error_message <- decode.optional_field(
  ...
  use status <- decode.field(
    "status",
    scaleway_containers_v1beta1_domain_status_decoder(),
  )
  use url <- decode.field("url", decode.string)
  decode.success(ScalewayContainersV1beta1Domain(
    container_id:,
    error_message:,
    hostname:,
    id:,
...
pub fn scaleway_containers_v1beta1_domain_to_json(
  value: ScalewayContainersV1beta1Domain,
) -> json.Json {
  json.object([
    #("container_id", json.string(value.container_id)),
    #("error_message", json.nullable(value.error_message, json.string)),
    ...
    #(
      "status",
      json.string(scaleway_containers_v1beta1_domain_status_to_string(
        value.status,
      )),
    ),
...
pub fn scaleway_containers_v1beta1_list_containers_response_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1ListContainersResponse,
) {
  use containers <- decode.field(
    "containers",
    decode.list(scaleway_containers_v1beta1_container_decoder()),
  )
  use total_count <- decode.field("total_count", decode.int)
  decode.success(ScalewayContainersV1beta1ListContainersResponse(
    containers:,
    total_count:,
  ))
}

pub fn scaleway_containers_v1beta1_list_containers_response_to_json(
  value: ScalewayContainersV1beta1ListContainersResponse,
) -> json.Json {
  json.object([
    #(
      "containers",
      json.array(value.containers, fn(item) {
        scaleway_containers_v1beta1_container_to_json(item)
      }),
    ),
...
pub fn scaleway_containers_v1beta1_list_crons_response_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1ListCronsResponse,
) {
  use crons <- decode.field(
    "crons",
    decode.list(scaleway_containers_v1beta1_cron_decoder()),
  )
  use total_count <- decode.field("total_count", decode.int)
  decode.success(ScalewayContainersV1beta1ListCronsResponse(
    crons:,
    total_count:,
  ))
}

pub fn scaleway_containers_v1beta1_list_crons_response_to_json(
  value: ScalewayContainersV1beta1ListCronsResponse,
) -> json.Json {
  json.object([
    #(
      "crons",
      json.array(value.crons, fn(item) {
        scaleway_containers_v1beta1_cron_to_json(item)
      }),
    ),
    #("total_count", json.int(value.total_count)),
  ])
...
pub fn scaleway_containers_v1beta1_list_domains_response_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1ListDomainsResponse,
) {
  use domains <- decode.field(
    "domains",
    decode.list(scaleway_containers_v1beta1_domain_decoder()),
  )
  use total_count <- decode.field("total_count", decode.int)
  decode.success(ScalewayContainersV1beta1ListDomainsResponse(
    domains:,
    total_count:,
  ))
}

pub fn scaleway_containers_v1beta1_list_domains_response_to_json(
  value: ScalewayContainersV1beta1ListDomainsResponse,
) -> json.Json {
  json.object([
    #(
      "domains",
      json.array(value.domains, fn(item) {
        scaleway_containers_v1beta1_domain_to_json(item)
      }),
    ),
    #("total_count", json.int(value.total_count)),
  ])
...
pub fn scaleway_containers_v1beta1_list_namespaces_response_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1ListNamespacesResponse,
) {
  use namespaces <- decode.field(
    "namespaces",
    decode.list(scaleway_containers_v1beta1_namespace_decoder()),
  )
  use total_count <- decode.field("total_count", decode.int)
  decode.success(ScalewayContainersV1beta1ListNamespacesResponse(
    namespaces:,
    total_count:,
  ))
}

pub fn scaleway_containers_v1beta1_list_namespaces_response_to_json(
  value: ScalewayContainersV1beta1ListNamespacesResponse,
) -> json.Json {
  json.object([
    #(
      "namespaces",
      json.array(value.namespaces, fn(item) {
        scaleway_containers_v1beta1_namespace_to_json(item)
      }),
    ),
    #("total_count", json.int(value.total_count)),
  ])
...
pub fn scaleway_containers_v1beta1_list_tokens_response_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1ListTokensResponse,
) {
  use tokens <- decode.field(
    "tokens",
    decode.list(scaleway_containers_v1beta1_token_decoder()),
  )
  use total_count <- decode.field("total_count", decode.int)
  decode.success(ScalewayContainersV1beta1ListTokensResponse(
    tokens:,
    total_count:,
  ))
}

pub fn scaleway_containers_v1beta1_list_tokens_response_to_json(
  value: ScalewayContainersV1beta1ListTokensResponse,
) -> json.Json {
  json.object([
    #(
      "tokens",
      json.array(value.tokens, fn(item) {
        scaleway_containers_v1beta1_token_to_json(item)
      }),
    ),
    #("total_count", json.int(value.total_count)),
  ])
...
pub fn scaleway_containers_v1beta1_list_triggers_response_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1ListTriggersResponse,
) {
  use total_count <- decode.field("total_count", decode.int)
  use triggers <- decode.field(
    "triggers",
    decode.list(scaleway_containers_v1beta1_trigger_decoder()),
  )
  decode.success(ScalewayContainersV1beta1ListTriggersResponse(
    total_count:,
    triggers:,
  ))
}

pub fn scaleway_containers_v1beta1_list_triggers_response_to_json(
  value: ScalewayContainersV1beta1ListTriggersResponse,
) -> json.Json {
  json.object([
    #("total_count", json.int(value.total_count)),
    #(
      "triggers",
      json.array(value.triggers, fn(item) {
        scaleway_containers_v1beta1_trigger_to_json(item)
      }),
    ),
  ])
}
...
pub fn scaleway_containers_v1beta1_namespace_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1Namespace,
) {
  use created_at <- decode.optional_field(
    "created_at",
  ...
  use registry_namespace_id <- decode.field(
  ...
  use status <- decode.field(
    "status",
    scaleway_containers_v1beta1_namespace_status_decoder(),
  )
  use tags <- decode.field("tags", decode.list(decode.string))
  use updated_at <- decode.optional_field(
    "updated_at",
  ...
  use vpc_integration_activated <- decode.field(
    "vpc_integration_activated",
    decode.bool,
  )
  decode.success(ScalewayContainersV1beta1Namespace(
    created_at:,
    description:,
    environment_variables:,
    error_message:,
...
pub fn scaleway_containers_v1beta1_namespace_to_json(
  value: ScalewayContainersV1beta1Namespace,
) -> json.Json {
  json.object([
    #("created_at", json.nullable(value.created_at, json.string)),
    #("description", json.nullable(value.description, json.string)),
    ...
    #(
      "status",
      json.string(scaleway_containers_v1beta1_namespace_status_to_string(
        value.status,
      )),
    ),
    #("tags", json.array(value.tags, fn(item) { json.string(item) })),
...
pub type ScalewayContainersV1beta1Secret {
  ScalewayContainersV1beta1Secret(key: String, value: GoogleProtobufStringValue)
}

pub fn scaleway_containers_v1beta1_secret_decoder() -> decode.Decoder(
...
pub fn scaleway_containers_v1beta1_secret_to_json(
  value: ScalewayContainersV1beta1Secret,
) -> json.Json {
  json.object([
...
pub type ScalewayContainersV1beta1SecretHashedValue {
  ScalewayContainersV1beta1SecretHashedValue(hashed_value: String, key: String)
}

pub fn scaleway_containers_v1beta1_secret_hashed_value_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1SecretHashedValue,
) {
...
pub fn scaleway_containers_v1beta1_secret_hashed_value_to_json(
  value: ScalewayContainersV1beta1SecretHashedValue,
) -> json.Json {
  json.object([
...
pub fn scaleway_containers_v1beta1_token_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1Token,
) {
  use container_id <- decode.optional_field(
    "container_id",
    None,
    decode.optional(decode.string),
  )
  ...
  use id <- decode.field("id", decode.string)
  use namespace_id <- decode.optional_field(
    "namespace_id",
    None,
    decode.optional(decode.string),
  )
  ...
  use status <- decode.field(
    "status",
    scaleway_containers_v1beta1_token_status_decoder(),
  )
  use token <- decode.field("token", decode.string)
  decode.success(ScalewayContainersV1beta1Token(
    container_id:,
    description:,
    expires_at:,
    id:,
...
pub fn scaleway_containers_v1beta1_token_to_json(
  value: ScalewayContainersV1beta1Token,
) -> json.Json {
  json.object([
    ...
    #(
      "status",
      json.string(scaleway_containers_v1beta1_token_status_to_string(
        value.status,
      )),
    ),
...
pub fn scaleway_containers_v1beta1_trigger_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1Trigger,
) {
  use container_id <- decode.field("container_id", decode.string)
  ...
  use id <- decode.field("id", decode.string)
  use input_type <- decode.field(
    "input_type",
    scaleway_containers_v1beta1_trigger_input_type_decoder(),
  )
  use name <- decode.field("name", decode.string)
  use scw_nats_config <- decode.optional_field(
    "scw_nats_config",
    None,
    decode.optional(decode.dynamic),
  )
  use scw_sqs_config <- decode.optional_field(
    "scw_sqs_config",
    None,
    decode.optional(decode.dynamic),
  )
  use status <- decode.field(
    "status",
    scaleway_containers_v1beta1_trigger_status_decoder(),
  )
  decode.success(ScalewayContainersV1beta1Trigger(
    container_id:,
    description:,
    error_message:,
    id:,
...
pub fn scaleway_containers_v1beta1_trigger_to_json(
  value: ScalewayContainersV1beta1Trigger,
) -> json.Json {
  json.object([
    #("container_id", json.string(value.container_id)),
    ...
    #(
      "input_type",
      json.string(scaleway_containers_v1beta1_trigger_input_type_to_string(
        value.input_type,
      )),
    ),
    #("name", json.string(value.name)),
    #(
      "scw_nats_config",
      json.nullable(value.scw_nats_config, fn(_) { json.null() }),
    ),
    #(
      "scw_sqs_config",
      json.nullable(value.scw_sqs_config, fn(_) { json.null() }),
    ),
    #(
      "status",
      json.string(scaleway_containers_v1beta1_trigger_status_to_string(
        value.status,
      )),
    ),
  ])
...
pub fn scaleway_containers_v1beta1_container_http_option_to_string(
  value: ScalewayContainersV1beta1ContainerHttpOption,
) -> String {
  case value {
    ScalewayContainersV1beta1ContainerHttpOptionUnknownHttpOption ->
      "unknown_http_option"
...
pub fn scaleway_containers_v1beta1_container_http_option_to_json(
  value: ScalewayContainersV1beta1ContainerHttpOption,
) -> json.Json {
  json.string(scaleway_containers_v1beta1_container_http_option_to_string(value))
}

pub fn scaleway_containers_v1beta1_container_http_option_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1ContainerHttpOption,
) {
  ...
  case value {
    ...
    "enabled" ->
      decode.success(ScalewayContainersV1beta1ContainerHttpOptionEnabled)
    "redirected" ->
      decode.success(ScalewayContainersV1beta1ContainerHttpOptionRedirected)
    _ ->
      decode.failure(
        ScalewayContainersV1beta1ContainerHttpOptionUnknownHttpOption,
        "ScalewayContainersV1beta1ContainerHttpOption",
...
pub fn scaleway_containers_v1beta1_container_privacy_to_string(
  value: ScalewayContainersV1beta1ContainerPrivacy,
) -> String {
  case value {
...
pub fn scaleway_containers_v1beta1_container_privacy_to_json(
  value: ScalewayContainersV1beta1ContainerPrivacy,
) -> json.Json {
  json.string(scaleway_containers_v1beta1_container_privacy_to_string(value))
}

pub fn scaleway_containers_v1beta1_container_privacy_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1ContainerPrivacy,
) {
  use value <- decode.then(decode.string)
  case value {
    "unknown_privacy" ->
      decode.success(ScalewayContainersV1beta1ContainerPrivacyUnknownPrivacy)
    "public" -> decode.success(ScalewayContainersV1beta1ContainerPrivacyPublic)
    "private" ->
      decode.success(ScalewayContainersV1beta1ContainerPrivacyPrivate)
    _ ->
      decode.failure(
        ScalewayContainersV1beta1ContainerPrivacyUnknownPrivacy,
        "ScalewayContainersV1beta1ContainerPrivacy",
...
pub fn scaleway_containers_v1beta1_container_protocol_to_string(
  value: ScalewayContainersV1beta1ContainerProtocol,
) -> String {
  case value {
    ScalewayContainersV1beta1ContainerProtocolUnknownProtocol ->
      "unknown_protocol"
...
pub fn scaleway_containers_v1beta1_container_protocol_to_json(
  value: ScalewayContainersV1beta1ContainerProtocol,
) -> json.Json {
  json.string(scaleway_containers_v1beta1_container_protocol_to_string(value))
}

pub fn scaleway_containers_v1beta1_container_protocol_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1ContainerProtocol,
) {
  use value <- decode.then(decode.string)
  case value {
    "unknown_protocol" ->
      decode.success(ScalewayContainersV1beta1ContainerProtocolUnknownProtocol)
...
pub fn scaleway_containers_v1beta1_container_sandbox_to_string(
  value: ScalewayContainersV1beta1ContainerSandbox,
) -> String {
  case value {
...
pub fn scaleway_containers_v1beta1_container_sandbox_to_json(
  value: ScalewayContainersV1beta1ContainerSandbox,
) -> json.Json {
  json.string(scaleway_containers_v1beta1_container_sandbox_to_string(value))
}

pub fn scaleway_containers_v1beta1_container_sandbox_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1ContainerSandbox,
) {
  use value <- decode.then(decode.string)
  case value {
    "unknown_sandbox" ->
      decode.success(ScalewayContainersV1beta1ContainerSandboxUnknownSandbox)
...
pub fn scaleway_containers_v1beta1_container_status_to_string(
  value: ScalewayContainersV1beta1ContainerStatus,
) -> String {
  case value {
...
pub fn scaleway_containers_v1beta1_container_status_to_json(
  value: ScalewayContainersV1beta1ContainerStatus,
) -> json.Json {
  json.string(scaleway_containers_v1beta1_container_status_to_string(value))
}

pub fn scaleway_containers_v1beta1_container_status_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1ContainerStatus,
) {
  use value <- decode.then(decode.string)
  case value {
    ...
    "deleting" ->
      decode.success(ScalewayContainersV1beta1ContainerStatusDeleting)
    ...
    "creating" ->
      decode.success(ScalewayContainersV1beta1ContainerStatusCreating)
    ...
    "upgrading" ->
      decode.success(ScalewayContainersV1beta1ContainerStatusUpgrading)
    _ ->
      decode.failure(
        ScalewayContainersV1beta1ContainerStatusUnknown,
        "ScalewayContainersV1beta1ContainerStatus",
...
pub fn scaleway_containers_v1beta1_cron_status_to_string(
  value: ScalewayContainersV1beta1CronStatus,
) -> String {
  case value {
...
pub fn scaleway_containers_v1beta1_cron_status_to_json(
  value: ScalewayContainersV1beta1CronStatus,
) -> json.Json {
  json.string(scaleway_containers_v1beta1_cron_status_to_string(value))
}

pub fn scaleway_containers_v1beta1_cron_status_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1CronStatus,
) {
  use value <- decode.then(decode.string)
  case value {
    ...
    "rebalancing" ->
      decode.success(ScalewayContainersV1beta1CronStatusRebalancing)
    _ ->
      decode.failure(
        ScalewayContainersV1beta1CronStatusUnknown,
        "ScalewayContainersV1beta1CronStatus",
...
pub fn scaleway_containers_v1beta1_domain_status_to_string(
  value: ScalewayContainersV1beta1DomainStatus,
) -> String {
  case value {
...
pub fn scaleway_containers_v1beta1_domain_status_to_json(
  value: ScalewayContainersV1beta1DomainStatus,
) -> json.Json {
  json.string(scaleway_containers_v1beta1_domain_status_to_string(value))
}

pub fn scaleway_containers_v1beta1_domain_status_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1DomainStatus,
) {
  use value <- decode.then(decode.string)
  case value {
    ...
    "upgrading" ->
      decode.success(ScalewayContainersV1beta1DomainStatusUpgrading)
    _ ->
      decode.failure(
        ScalewayContainersV1beta1DomainStatusUnknown,
        "ScalewayContainersV1beta1DomainStatus",
...
pub fn scaleway_containers_v1beta1_namespace_status_to_string(
  value: ScalewayContainersV1beta1NamespaceStatus,
) -> String {
  case value {
...
pub fn scaleway_containers_v1beta1_namespace_status_to_json(
  value: ScalewayContainersV1beta1NamespaceStatus,
) -> json.Json {
  json.string(scaleway_containers_v1beta1_namespace_status_to_string(value))
}

pub fn scaleway_containers_v1beta1_namespace_status_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1NamespaceStatus,
) {
  use value <- decode.then(decode.string)
  case value {
    ...
    "deleting" ->
      decode.success(ScalewayContainersV1beta1NamespaceStatusDeleting)
    ...
    "creating" ->
      decode.success(ScalewayContainersV1beta1NamespaceStatusCreating)
    ...
    "upgrading" ->
      decode.success(ScalewayContainersV1beta1NamespaceStatusUpgrading)
    _ ->
      decode.failure(
        ScalewayContainersV1beta1NamespaceStatusUnknown,
        "ScalewayContainersV1beta1NamespaceStatus",
...
pub fn scaleway_containers_v1beta1_token_status_to_string(
  value: ScalewayContainersV1beta1TokenStatus,
) -> String {
  case value {
...
pub fn scaleway_containers_v1beta1_token_status_to_json(
  value: ScalewayContainersV1beta1TokenStatus,
) -> json.Json {
  json.string(scaleway_containers_v1beta1_token_status_to_string(value))
}

pub fn scaleway_containers_v1beta1_token_status_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1TokenStatus,
) {
  use value <- decode.then(decode.string)
  case value {
...
pub fn scaleway_containers_v1beta1_trigger_input_type_to_string(
  value: ScalewayContainersV1beta1TriggerInputType,
) -> String {
  case value {
    ScalewayContainersV1beta1TriggerInputTypeUnknownInputType ->
      "unknown_input_type"
...
pub fn scaleway_containers_v1beta1_trigger_input_type_to_json(
  value: ScalewayContainersV1beta1TriggerInputType,
) -> json.Json {
  json.string(scaleway_containers_v1beta1_trigger_input_type_to_string(value))
}

pub fn scaleway_containers_v1beta1_trigger_input_type_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1TriggerInputType,
) {
  use value <- decode.then(decode.string)
  case value {
    "unknown_input_type" ->
      decode.success(ScalewayContainersV1beta1TriggerInputTypeUnknownInputType)
    ...
    "scw_nats" ->
      decode.success(ScalewayContainersV1beta1TriggerInputTypeScwNats)
    _ ->
      decode.failure(
        ScalewayContainersV1beta1TriggerInputTypeUnknownInputType,
        "ScalewayContainersV1beta1TriggerInputType",
...
pub fn scaleway_containers_v1beta1_trigger_status_to_string(
  value: ScalewayContainersV1beta1TriggerStatus,
) -> String {
  case value {
...
pub fn scaleway_containers_v1beta1_trigger_status_to_json(
  value: ScalewayContainersV1beta1TriggerStatus,
) -> json.Json {
  json.string(scaleway_containers_v1beta1_trigger_status_to_string(value))
}

pub fn scaleway_containers_v1beta1_trigger_status_decoder() -> decode.Decoder(
  ScalewayContainersV1beta1TriggerStatus,
) {
  use value <- decode.then(decode.string)
  case value {
    "unknown_status" ->
      decode.success(ScalewayContainersV1beta1TriggerStatusUnknownStatus)
    ...
    "upgrading" ->
      decode.success(ScalewayContainersV1beta1TriggerStatusUpgrading)
    _ ->
      decode.failure(
        ScalewayContainersV1beta1TriggerStatusUnknownStatus,
        "ScalewayContainersV1beta1TriggerStatus",
...
/// ```
/// 
/// 8. (optional) Connect to your Cockpit (Serverless Containers Logs dashboard) to see your logs: https://www.scaleway.com/en/docs/observability/cockpit/how-to/access-grafana-and-managed-dashboards/.
/// 
...
/// ```
/// 
/// Additionally, the loki endpoint (`https://logs.cockpit.fr-par.scw.cloud`) can be used to query programmatically the containers logs using a [token](https://www.scaleway.com/en/docs/observability/cockpit/how-to/create-token/).
/// 
/// ## Going further
/// 
...
pub opaque type Client(err) {
  Client(
    http_client: fn(request.Request(String)) ->
      Result(response.Response(String), err),
    base_url: String,
  )
}
...
pub fn with_base_url(client: Client(err), base_url: String) -> Client(err) {
...
pub fn list_containers(
  ...
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
  )
  json.parse(
    resp.body,
    scaleway_containers_v1beta1_list_containers_response_decoder(),
  )
  |> result.map_error(JsonDecodeError)
}

pub type CreateContainerRequestHttpOption {
  CreateContainerRequestHttpOptionUnknownHttpOption
  CreateContainerRequestHttpOptionEnabled
  CreateContainerRequestHttpOptionRedirected
}

pub fn create_container_request_http_option_to_string(
  value: CreateContainerRequestHttpOption,
) -> String {
  case value {
    CreateContainerRequestHttpOptionUnknownHttpOption -> "unknown_http_option"
    CreateContainerRequestHttpOptionEnabled -> "enabled"
    CreateContainerRequestHttpOptionRedirected -> "redirected"
  }
}

pub fn create_container_request_http_option_to_json(
  value: CreateContainerRequestHttpOption,
) -> json.Json {
  json.string(create_container_request_http_option_to_string(value))
}

pub fn create_container_request_http_option_decoder() -> decode.Decoder(
  CreateContainerRequestHttpOption,
) {
  use value <- decode.then(decode.string)
  case value {
    "unknown_http_option" ->
      decode.success(CreateContainerRequestHttpOptionUnknownHttpOption)
    "enabled" -> decode.success(CreateContainerRequestHttpOptionEnabled)
    "redirected" -> decode.success(CreateContainerRequestHttpOptionRedirected)
    _ ->
      decode.failure(
        CreateContainerRequestHttpOptionUnknownHttpOption,
        "CreateContainerRequestHttpOption",
...
pub fn create_container_request_privacy_to_string(
  value: CreateContainerRequestPrivacy,
) -> String {
  case value {
...
pub fn create_container_request_privacy_to_json(
  value: CreateContainerRequestPrivacy,
) -> json.Json {
  json.string(create_container_request_privacy_to_string(value))
}

pub fn create_container_request_privacy_decoder() -> decode.Decoder(
  CreateContainerRequestPrivacy,
) {
  use value <- decode.then(decode.string)
  case value {
    "unknown_privacy" ->
      decode.success(CreateContainerRequestPrivacyUnknownPrivacy)
...
pub fn create_container_request_protocol_to_string(
  value: CreateContainerRequestProtocol,
) -> String {
  case value {
...
pub fn create_container_request_protocol_to_json(
  value: CreateContainerRequestProtocol,
) -> json.Json {
  json.string(create_container_request_protocol_to_string(value))
}

pub fn create_container_request_protocol_decoder() -> decode.Decoder(
  CreateContainerRequestProtocol,
) {
  use value <- decode.then(decode.string)
  case value {
    "unknown_protocol" ->
      decode.success(CreateContainerRequestProtocolUnknownProtocol)
...
pub fn create_container_request_sandbox_to_string(
  value: CreateContainerRequestSandbox,
) -> String {
  case value {
...
pub fn create_container_request_sandbox_to_json(
  value: CreateContainerRequestSandbox,
) -> json.Json {
  json.string(create_container_request_sandbox_to_string(value))
}

pub fn create_container_request_sandbox_decoder() -> decode.Decoder(
  CreateContainerRequestSandbox,
) {
  use value <- decode.then(decode.string)
  case value {
    "unknown_sandbox" ->
      decode.success(CreateContainerRequestSandboxUnknownSandbox)
...
pub fn create_container_request_decoder() -> decode.Decoder(
  CreateContainerRequest,
) {
  use args <- decode.field("args", decode.list(decode.string))
  use command <- decode.field("command", decode.list(decode.string))
  use cpu_limit <- decode.optional_field(
    "cpu_limit",
    None,
  ...
  use environment_variables <- decode.optional_field(
    "environment_variables",
    None,
    decode.optional(decode.dynamic),
  )
  ...
  use http_option <- decode.field(
    "http_option",
    create_container_request_http_option_decoder(),
  )
  use local_storage_limit <- decode.optional_field(
    "local_storage_limit",
    None,
    decode.optional(decode.int),
  )
  use max_concurrency <- decode.optional_field(
    "max_concurrency",
    None,
    decode.optional(decode.int),
  )
  use max_scale <- decode.optional_field(
    "max_scale",
    None,
    decode.optional(decode.int),
  )
  ...
  use min_scale <- decode.optional_field(
    "min_scale",
    None,
    decode.optional(decode.int),
  )
  ...
  use privacy <- decode.field(
    "privacy",
    create_container_request_privacy_decoder(),
  )
  use private_network_id <- decode.optional_field(
    "private_network_id",
    None,
  ...
  use protocol <- decode.field(
    "protocol",
    create_container_request_protocol_decoder(),
  )
  use registry_image <- decode.optional_field(
    "registry_image",
    None,
    decode.optional(decode.string),
  )
  use sandbox <- decode.field(
    "sandbox",
    create_container_request_sandbox_decoder(),
  )
  use scaling_option <- decode.field("scaling_option", decode.dynamic)
  use secret_environment_variables <- decode.field(
    "secret_environment_variables",
    decode.list(scaleway_containers_v1beta1_secret_decoder()),
  )
  use tags <- decode.field("tags", decode.list(decode.string))
  use timeout <- decode.optional_field(
    "timeout",
  ...
  decode.success(CreateContainerRequest(
    args:,
    command:,
    cpu_limit:,
    description:,
...
pub fn create_container_request_to_json(
  ...
  json.object([
    #("args", json.array(value.args, fn(item) { json.string(item) })),
    #("command", json.array(value.command, fn(item) { json.string(item) })),
    #("cpu_limit", json.nullable(value.cpu_limit, json.int)),
    #("description", json.nullable(value.description, json.string)),
    #(
      "environment_variables",
      json.nullable(value.environment_variables, fn(_) { json.null() }),
    ),
    #("health_check", json.null()),
    #(
      "http_option",
      json.string(create_container_request_http_option_to_string(
        value.http_option,
      )),
    ),
    #("local_storage_limit", json.nullable(value.local_storage_limit, json.int)),
    #("max_concurrency", json.nullable(value.max_concurrency, json.int)),
    #("max_scale", json.nullable(value.max_scale, json.int)),
    #("memory_limit", json.nullable(value.memory_limit, json.int)),
    ...
    #(
      "privacy",
      json.string(create_container_request_privacy_to_string(value.privacy)),
    ),
    #(
      "private_network_id",
      json.nullable(value.private_network_id, json.string),
    ...
    #(
      "protocol",
      json.string(create_container_request_protocol_to_string(value.protocol)),
    ),
    #("registry_image", json.nullable(value.registry_image, json.string)),
    #(
      "sandbox",
      json.string(create_container_request_sandbox_to_string(value.sandbox)),
    ),
    #("scaling_option", json.null()),
    #(
      "secret_environment_variables",
      json.array(value.secret_environment_variables, fn(item) {
        scaleway_containers_v1beta1_secret_to_json(item)
      }),
    ),
    #("tags", json.array(value.tags, fn(item) { json.string(item) })),
    #("timeout", json.nullable(value.timeout, json.string)),
...
pub fn create_container(
  ...
  let req =
    request.set_body(
      req,
      json.to_string(create_container_request_to_json(body)),
    )
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
  )
...
pub type UpdateContainerRequestHttpOption {
  UpdateContainerRequestHttpOptionUnknownHttpOption
  UpdateContainerRequestHttpOptionEnabled
  UpdateContainerRequestHttpOptionRedirected
}

pub fn update_container_request_http_option_to_string(
  value: UpdateContainerRequestHttpOption,
) -> String {
  case value {
    UpdateContainerRequestHttpOptionUnknownHttpOption -> "unknown_http_option"
    UpdateContainerRequestHttpOptionEnabled -> "enabled"
    UpdateContainerRequestHttpOptionRedirected -> "redirected"
  }
}

pub fn update_container_request_http_option_to_json(
  value: UpdateContainerRequestHttpOption,
) -> json.Json {
  json.string(update_container_request_http_option_to_string(value))
}

pub fn update_container_request_http_option_decoder() -> decode.Decoder(
  UpdateContainerRequestHttpOption,
) {
  use value <- decode.then(decode.string)
  case value {
    "unknown_http_option" ->
      decode.success(UpdateContainerRequestHttpOptionUnknownHttpOption)
    "enabled" -> decode.success(UpdateContainerRequestHttpOptionEnabled)
    "redirected" -> decode.success(UpdateContainerRequestHttpOptionRedirected)
    _ ->
      decode.failure(
        UpdateContainerRequestHttpOptionUnknownHttpOption,
        "UpdateContainerRequestHttpOption",
...
pub fn update_container_request_privacy_to_string(
  value: UpdateContainerRequestPrivacy,
) -> String {
  case value {
...
pub fn update_container_request_privacy_to_json(
  value: UpdateContainerRequestPrivacy,
) -> json.Json {
  json.string(update_container_request_privacy_to_string(value))
}

pub fn update_container_request_privacy_decoder() -> decode.Decoder(
  UpdateContainerRequestPrivacy,
) {
  use value <- decode.then(decode.string)
  case value {
    "unknown_privacy" ->
      decode.success(UpdateContainerRequestPrivacyUnknownPrivacy)
...
pub fn update_container_request_protocol_to_string(
  value: UpdateContainerRequestProtocol,
) -> String {
  case value {
...
pub fn update_container_request_protocol_to_json(
  value: UpdateContainerRequestProtocol,
) -> json.Json {
  json.string(update_container_request_protocol_to_string(value))
}

pub fn update_container_request_protocol_decoder() -> decode.Decoder(
  UpdateContainerRequestProtocol,
) {
  use value <- decode.then(decode.string)
  case value {
    "unknown_protocol" ->
      decode.success(UpdateContainerRequestProtocolUnknownProtocol)
...
pub fn update_container_request_sandbox_to_string(
  value: UpdateContainerRequestSandbox,
) -> String {
  case value {
...
pub fn update_container_request_sandbox_to_json(
  value: UpdateContainerRequestSandbox,
) -> json.Json {
  json.string(update_container_request_sandbox_to_string(value))
}

pub fn update_container_request_sandbox_decoder() -> decode.Decoder(
  UpdateContainerRequestSandbox,
) {
  use value <- decode.then(decode.string)
  case value {
    "unknown_sandbox" ->
      decode.success(UpdateContainerRequestSandboxUnknownSandbox)
...
pub fn update_container_request_decoder() -> decode.Decoder(
  UpdateContainerRequest,
) {
  ...
  use http_option <- decode.field(
    "http_option",
    update_container_request_http_option_decoder(),
  )
  use local_storage_limit <- decode.optional_field(
    "local_storage_limit",
    None,
  ...
  use privacy <- decode.field(
    "privacy",
    update_container_request_privacy_decoder(),
  )
  use private_network_id <- decode.optional_field(
    "private_network_id",
    None,
  ...
  use protocol <- decode.field(
    "protocol",
    update_container_request_protocol_decoder(),
  )
  use redeploy <- decode.optional_field(
    "redeploy",
    None,
  ...
  use sandbox <- decode.field(
    "sandbox",
    update_container_request_sandbox_decoder(),
  )
  use scaling_option <- decode.field("scaling_option", decode.dynamic)
  use secret_environment_variables <- decode.field(
    "secret_environment_variables",
  ...
  decode.success(UpdateContainerRequest(
    args:,
    command:,
    cpu_limit:,
    description:,
...
pub fn update_container_request_to_json(
  value: UpdateContainerRequest,
) -> json.Json {
  json.object([
    ...
    #(
      "http_option",
      json.string(update_container_request_http_option_to_string(
        value.http_option,
      )),
    ),
    #("local_storage_limit", json.nullable(value.local_storage_limit, json.int)),
    ...
    #(
      "privacy",
      json.string(update_container_request_privacy_to_string(value.privacy)),
    ),
    #(
      "private_network_id",
      json.nullable(value.private_network_id, json.string),
    ...
    #(
      "protocol",
      json.string(update_container_request_protocol_to_string(value.protocol)),
    ),
    #("redeploy", json.nullable(value.redeploy, json.bool)),
    #("registry_image", json.nullable(value.registry_image, json.string)),
    #(
      "sandbox",
      json.string(update_container_request_sandbox_to_string(value.sandbox)),
    ),
    #("scaling_option", json.null()),
    #(
      "secret_environment_variables",
...
pub fn update_container(
  ...
  let req =
    request.set_body(
      req,
      json.to_string(update_container_request_to_json(body)),
    )
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
  )
...
pub fn deploy_container_request_decoder() -> decode.Decoder(
  DeployContainerRequest,
) {
  decode.success(DeployContainerRequest)
}

pub fn deploy_container_request_to_json(
  value: DeployContainerRequest,
) -> json.Json {
  json.object([])
}
...
pub fn deploy_container(
  ...
  let req =
    request.set_body(
      req,
      json.to_string(deploy_container_request_to_json(body)),
    )
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
  )
...
pub fn list_crons(
  ...
  let assert Ok(req) =
    request.to(
      client.base_url <> "/containers/v1beta1/regions/" <> region <> "/crons",
    )
  let req = request.set_method(req, http.Get)
  let req = request.prepend_header(req, "content-type", "application/json")
  let query = []
  ...
  json.parse(
    resp.body,
    scaleway_containers_v1beta1_list_crons_response_decoder(),
  )
  |> result.map_error(JsonDecodeError)
}
...
pub fn create_cron(
  ...
  let req = request.prepend_header(req, "content-type", "application/json")
  let req =
    request.set_body(req, json.to_string(create_cron_request_to_json(body)))
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
  )
  json.parse(resp.body, scaleway_containers_v1beta1_cron_decoder())
  |> result.map_error(JsonDecodeError)
}
...
pub fn update_cron_request_to_json(value: UpdateCronRequest) -> json.Json {
  json.object([
    ...
    #("container_id", json.nullable(value.container_id, json.string)),
    #("name", json.nullable(value.name, json.string)),
    #("schedule", json.nullable(value.schedule, json.string)),
  ])
}
...
pub fn update_cron(
  ...
  let req = request.prepend_header(req, "content-type", "application/json")
  let req =
    request.set_body(req, json.to_string(update_cron_request_to_json(body)))
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
  )
  json.parse(resp.body, scaleway_containers_v1beta1_cron_decoder())
...
pub fn list_domains(
  ...
  let assert Ok(req) =
    request.to(
      client.base_url <> "/containers/v1beta1/regions/" <> region <> "/domains",
    )
  let req = request.set_method(req, http.Get)
  let req = request.prepend_header(req, "content-type", "application/json")
  let query = []
  ...
  json.parse(
    resp.body,
    scaleway_containers_v1beta1_list_domains_response_decoder(),
  )
  |> result.map_error(JsonDecodeError)
}
...
pub fn create_domain(
  ...
  let req = request.prepend_header(req, "content-type", "application/json")
  let req =
    request.set_body(req, json.to_string(create_domain_request_to_json(body)))
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
  )
  json.parse(resp.body, scaleway_containers_v1beta1_domain_decoder())
  |> result.map_error(JsonDecodeError)
}
...
pub fn list_namespaces(
  ...
  json.parse(
    resp.body,
    scaleway_containers_v1beta1_list_namespaces_response_decoder(),
  )
  |> result.map_error(JsonDecodeError)
}
...
pub fn create_namespace_request_decoder() -> decode.Decoder(
  CreateNamespaceRequest,
) {
  use activate_vpc_integration <- decode.field(
  ...
  use tags <- decode.field("tags", decode.list(decode.string))
  decode.success(CreateNamespaceRequest(
    activate_vpc_integration:,
    description:,
    environment_variables:,
    name:,
...
pub fn create_namespace_request_to_json(
...
pub fn create_namespace(
  ...
  let req =
    request.set_body(
      req,
      json.to_string(create_namespace_request_to_json(body)),
    )
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
  )
  json.parse(resp.body, scaleway_containers_v1beta1_namespace_decoder())
  |> result.map_error(JsonDecodeError)
}
...
pub fn update_namespace_request_decoder() -> decode.Decoder(
  UpdateNamespaceRequest,
) {
  use description <- decode.optional_field(
    "description",
  ...
  decode.success(UpdateNamespaceRequest(
    description:,
    environment_variables:,
    secret_environment_variables:,
    tags:,
...
pub fn update_namespace_request_to_json(
...
pub fn update_namespace(
  ...
  let req =
    request.set_body(
      req,
      json.to_string(update_namespace_request_to_json(body)),
    )
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
  )
...
pub fn list_tokens(
  ...
  let assert Ok(req) =
    request.to(
      client.base_url <> "/containers/v1beta1/regions/" <> region <> "/tokens",
    )
  let req = request.set_method(req, http.Get)
  let req = request.prepend_header(req, "content-type", "application/json")
  let query = []
  ...
  json.parse(
    resp.body,
    scaleway_containers_v1beta1_list_tokens_response_decoder(),
  )
  |> result.map_error(JsonDecodeError)
}
...
pub fn create_token_request_decoder() -> decode.Decoder(CreateTokenRequest) {
  ...
  decode.success(CreateTokenRequest(
    container_id:,
    description:,
    expires_at:,
    namespace_id:,
...
pub fn create_token(
  ...
  let req = request.prepend_header(req, "content-type", "application/json")
  let req =
    request.set_body(req, json.to_string(create_token_request_to_json(body)))
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
  )
  json.parse(resp.body, scaleway_containers_v1beta1_token_decoder())
  |> result.map_error(JsonDecodeError)
}
...
pub fn list_triggers(
  ...
  let assert Ok(req) =
    request.to(
      client.base_url <> "/containers/v1beta1/regions/" <> region <> "/triggers",
    )
  let req = request.set_method(req, http.Get)
  let req = request.prepend_header(req, "content-type", "application/json")
  let query = []
  ...
  json.parse(
    resp.body,
    scaleway_containers_v1beta1_list_triggers_response_decoder(),
  )
  |> result.map_error(JsonDecodeError)
}
...
pub fn create_trigger_request_decoder() -> decode.Decoder(CreateTriggerRequest) {
  ...
  decode.success(CreateTriggerRequest(
    container_id:,
    description:,
    name:,
    scw_nats_config:,
...
pub fn create_trigger(
  ...
  let req = request.prepend_header(req, "content-type", "application/json")
  let req =
    request.set_body(req, json.to_string(create_trigger_request_to_json(body)))
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
  )
  json.parse(resp.body, scaleway_containers_v1beta1_trigger_decoder())
  |> result.map_error(JsonDecodeError)
}
...
pub fn update_trigger(
  ...
  let req = request.prepend_header(req, "content-type", "application/json")
  let req =
    request.set_body(req, json.to_string(update_trigger_request_to_json(body)))
  use resp <- result.try(
    client.http_client(req) |> result.map_error(ClientError),
  )
  json.parse(resp.body, scaleway_containers_v1beta1_trigger_decoder())
