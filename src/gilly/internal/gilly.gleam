...
pub fn with_version(builder: Builder, version: String) -> Builder {
...
pub fn generate_code_from_file(
  ...
  let header = generate_header(builder.version, source)
  Ok(header <> "\n\n" <> code)
}
...
const header_comment = "// Code generated by Gilly (<version>) from OpenAPI specification at '<source_path>'. DO NOT EDIT.
